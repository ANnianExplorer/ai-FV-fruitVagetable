...
import com.yzh.fv.dto.DishDto;
import com.yzh.fv.dto.SetmealDto;
...
import com.yzh.fv.service.SetmealDishService;
...
public class SetmealController {
    ...
    public R<String> statusStart(@RequestParam List<Long> ids){
        ...
        return R.success("组合已经启售！");
    }

    /**
     * 点击组合图片查看组合具体内容
     * 前端主要要展示的信息是:组合中菜品的基本信息，图片，菜品描述，以及菜品的份数
     * @param id
     * @return
     */
    // todo 该页面未解决，无法展示
